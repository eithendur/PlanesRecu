...
story.append(Paragraph("# Instalar Composer (directo, recomendado)", normal_style))
story.append(Paragraph("sudo curl -sS https://getcomposer.org/download/latest-stable/composer.phar -o /usr/local/bin/composer", normal_style))
story.append(Paragraph("sudo chmod +x /usr/local/bin/composer", normal_style))
story.append(Spacer(1, 0.2*inch))
...
story.append(Paragraph("Crear archivo /etc/apache2/sites-available/planes.conf:", normal_style))
...
story.append(Paragraph("        AllowOverride None", normal_style))
...
story.append(Spacer(1, 0.2*inch))
story.append(Paragraph("Activar sitio:", normal_style))
story.append(Paragraph("a2ensite planes.conf", normal_style))
story.append(Paragraph("systemctl reload apache2", normal_style))
story.append(Spacer(1, 0.2*inch))
